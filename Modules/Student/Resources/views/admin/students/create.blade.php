...
@section('content-header')
    <h1>
        {{ trans('student::students.title.create student') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.student.student.index') }}">{{ trans('student::students.title.students') }}</a></li>
        <li class="active">{{ trans('student::students.title.create student') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.student.student.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('student::admin.students.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
