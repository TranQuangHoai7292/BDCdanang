...
<div class="box-body">   
    <div class ="row">
        <div class ="col-sm-6">
            ...
            <!-- <?php echo Form::normalInput('address', 'Địa chỉ', $errors); ?> -->
            <!-- <div class="form-group dropdown">
        ...
        <div class ="col-sm-6">
            <?php echo Form::normalInput('mail', 'Email', $errors); ?>
            ...
            <!-- <?php echo Form::normalInput('custom_field1', 'Thông tin khác 1', $errors); ?>

            <?php echo Form::normalInput('custom_field2', 'Thông tin khác 2', $errors); ?>

            <?php echo Form::normalInput('custom_field3', 'Thông tin khác 3', $errors); ?> -->
        </div>   
        <div class="col-md-12">
            <div class="form-group dropdown">
                ...
                <select id="country_id" name="country_id" class="form-control">
                    ...
                    <option value="<?php echo e($countrie->id); ?>"><?php echo e($countrie->name); ?></option>
                    <?php }?>
                </select>
             </div>
        </div>    
