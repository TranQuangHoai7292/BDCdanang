    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background: #f5f7fa!important;border-color: #f5f7fa!important;">
                <button type="button" style="background: #8d8787;" class="btn btn-outline btn-flat pull-right" data-dismiss="modal"><?php echo e(trans('core::core.button.cancel')); ?></button>
                <?php echo Form::open(['method' => 'delete', 'class' => 'pull-right']); ?>

                <button type="submit" style="background:#dd4b39;" class="btn btn-outline btn-flat"><i class="fa fa-trash"></i> <?php echo e(trans('core::core.button.delete')); ?></button>
                <?php echo Form::close(); ?>
