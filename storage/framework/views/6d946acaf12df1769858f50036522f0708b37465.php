<?php $__env->startSection('content-header'); ?>
    <h1>
        <?php echo e(trans('register::registers.title.registers')); ?>

    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(route('dashboard.index')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('core::core.breadcrumb.home')); ?></a></li>
        <li class="active"><?php echo e(trans('register::registers.title.registers')); ?></li>
    </ol>
                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                        <?php echo e($register->birth); ?>

                                </td>
                                <td>
                                        <?php echo e($register->name_parent); ?>

                                </td>
                                <td>
                                        <?php echo e($register->phone); ?>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" id="viewInfoCusomer" class="btn btn-secondary h-btn" onclick="viewDetail(<?php echo e($register->id); ?>)"><i class="fa fa-eye" aria-hidden="true">
                                            </i></button>
                                        <button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="<?php echo e(route('admin.register.register.destroy', [$register->id])); ?>"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
...
<?php $__env->startSection('shortcuts'); ?>
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd><?php echo e(trans('register::registers.title.create register')); ?></dd>
    </dl>
<?php $__env->stopSection(); ?>
