<?php $__env->startSection('content-header'); ?>
    <h1>
        <?php echo e(trans('service::services.title.edit service')); ?>

    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(route('dashboard.index')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('core::core.breadcrumb.home')); ?></a></li>
        <li><a href="<?php echo e(route('admin.service.service.index')); ?>"><?php echo e(trans('service::services.title.services')); ?></a></li>
        <li class="active"><?php echo e(trans('service::services.title.edit service')); ?></li>
    </ol>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo Form::open(['route' => ['admin.service.service.update', $service->id], 'method' => 'put']); ?>
                ...
                <div class="tab-content">
                    ...
                    <?php $__currentLoopData = LaravelLocalization::getSupportedLocales(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tab-pane <?php echo e(locale() == $locale ? 'active' : ''); ?>" id="tab_<?php echo e($i); ?>">
                            <?php echo $__env->make('service::admin.services.partials.edit-fields', ['lang' => $locale], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat"><?php echo e(trans('core::core.button.update')); ?></button>
                        <a class="btn btn-danger pull-right btn-flat" href="<?php echo e(route('admin.service.service.index')); ?>"><i class="fa fa-times"></i> <?php echo e(trans('core::core.button.cancel')); ?></a>
                    </div>
                </div>
            </div> 
        </div>
...
<?php $__env->startPush('js-stack'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#datetimepicker3,#datetimepicker-3').datetimepicker({
                format: 'LT'
            });
        });
    </script>
