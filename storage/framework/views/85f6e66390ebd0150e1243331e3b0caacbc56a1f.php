<?php $__env->startSection('content-header'); ?>
    <h1>
        <?php echo e(trans('invoices::invoices.title.create invoice')); ?>

    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(route('dashboard.index')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('core::core.breadcrumb.home')); ?></a></li>
        <li><a href="<?php echo e(route('admin.invoices.invoice.index')); ?>"><?php echo e(trans('invoices::invoices.title.invoices')); ?></a></li>
        <li class="active"><?php echo e(trans('invoices::invoices.title.create invoice')); ?></li>
    </ol>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo Form::open(['route' => ['admin.invoices.invoice.store'], 'method' => 'post']); ?>
                ...
                <div class="tab-content">
                    ...
                    <?php $__currentLoopData = LaravelLocalization::getSupportedLocales(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tab-pane <?php echo e(locale() == $locale ? 'active' : ''); ?>" id="tab_<?php echo e($i); ?>">
                            <?php echo $__env->make('invoices::admin.invoices.partials.create-fields', ['lang' => $locale], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat">Thêm mới</button>
                        <a class="btn btn-danger pull-right btn-flat" href="<?php echo e(route('admin.invoices.invoice.index')); ?>"><i class="fa fa-times"></i> Hủy</a>
                    </div>
                </div>
            </div> 
        </div>
    ...
    <form method ="post" id ="insert_form">
      <div class="modal-header c-header">
        ...
        <div class="modal-body">
            <?php echo $__env->make('customers::admin.customers.partials.create-fields', ['lang' => $locale], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
...
<?php echo Theme::script('vendor/jquery/chosen.jquery.js'); ?>

<?php echo Theme::script('js/jquery.formula.js'); ?>

<?php echo Theme::style('css/chosen.css'); ?>
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        $('#datetimepickerdathang').datetimepicker({
            ...
            sideBySide: true,
            // minDate: new Date("<?php echo date('Y-m-d 00:00'); ?>")
        });
