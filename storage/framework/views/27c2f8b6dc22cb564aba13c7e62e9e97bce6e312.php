    ...
    <div class="col-xs-12">
        <div class="row">
            <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                <a href="<?php echo e(route('admin.user.user.create')); ?>" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                ...
                <table class="data-table table table-bordered table-hover">
                    ...
                    <?php if (isset($users)): ?>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td>
                                    <a href="<?php echo e(route('admin.user.user.edit', [$user->id])); ?>">
                                        <?php echo e($user->id); ?>
