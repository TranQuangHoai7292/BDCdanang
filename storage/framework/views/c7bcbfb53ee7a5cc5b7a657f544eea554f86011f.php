        ...
        <div class="form-group dropdown" id="khachhang">
            ...
            <select name="customer_id" id="customer_id" class="form-control blah">
                ...
                <?php foreach ($customers_select as $c) {?>
                    <option data-id-custumer="<?php echo e($c->id); ?>" value="<?php echo e($c->id); ?>"><?php echo e($c->firstname .' '.$c->lastname); ?> </option>
                <?php }?>
            </select>
        </div> 
    </div>
...
<div class = "row">
        ...
        <div class="form-group dropdown">
                ...
                <select name="tour_guide_id" id="tour_guide_id" class="form-control">
                    ...
                    <?php foreach ($tourguides as $tourguide) {?>
                        <option value="<?php echo e($tourguide->id); ?>"><?php echo e($tourguide->firstname .' '.$tourguide->lastname); ?> - <?php echo e($tourguide->phone); ?> </option>
                    <?php }?>
                </select>
        </div> 
    ...
    <div class ="col-sm-6">
        <?php echo Form::normalInput('seller', 'Người bán', $errors); ?>
    ...
    <!-- <?php echo Form::normalInput('delivery_address', 'Địa chỉ giao hàng', $errors); ?> -->
    <!-- <?php echo Form::normalInput('delivery_name', 'Tên người giao hàng', $errors); ?>

    <?php echo Form::normalInput('delivery_phone', 'Điện thoại giao hàng', $errors); ?>

    <?php echo Form::normalInput('delivery_note', 'Ghi chú giao hàng', $errors); ?>

    <?php echo Form::normalInput('billing_name', 'Tên người đứng hóa đơn', $errors); ?>

    <?php echo Form::normalInput('billing_phone', 'Điện thoại người thanh toán', $errors); ?>    -->
    
    </div>
</div>
  <?php echo Form:: normalTextarea('note', 'Ghi chú', $errors); ?> 
</div>
<!-- Model view -->
