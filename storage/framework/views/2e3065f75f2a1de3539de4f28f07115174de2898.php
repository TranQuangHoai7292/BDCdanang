<div class="box-body">
    <div class="row">
        <div class="col-sm-6">
            <?php echo Form::normalInput('name', 'Tên Trung Tâm', $errors); ?>
        ...
        <div class="col-sm-6">
            ...
            <?php echo Form::normalInput('name_manager', 'Người Quản Lý', $errors); ?>
    ...
    <?php echo Form::normalTextarea('description', 'Giới Thiệu Trung Tâm', $errors); ?>
